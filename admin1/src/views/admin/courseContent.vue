                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" v-model="courseContent.id" class="form-control" placeholder="课程内容id" name="courseContentId">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">课程内容</label>
                                    <div class="col-sm-10">
                                        <input type="text" v-model="courseContent.content" class="form-control" placeholder="课程内容" name="courseContentContent">
                                    </div>
                                </div>
                        </form>
                    </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            //调用父组件的方法
            //this.$parent.activeSlidebar("business-courseContent-sidebar")
            let _this = this
        ...
        methods:{
            ...
            save(){
                ...
                if(!bootstrapValidator1.isValid()){
                    ...
                    _this.ajax.post(process.env.VUE_APP_SERVER+'/business/admin/courseContent/save',
                        _this.courseContent).then((response)=>{
                        Loading.hide()
            ...
            edit(courseContent){
                ...
                _this.courseContent = $.extend({},courseContent)//临时放到{}中
                $("#form-modal").modal("show")
            },
